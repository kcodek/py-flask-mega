...
def login():
    ...
    if form.validate_on_submit():
        ...
        will intercept the request and respond with a redirect to /login but
         it will add a query string argument to this URL, making the complete redirect URL /login?next=/index.
